...
CREATE TABLE `users` (
    ...
    `defaultShippingAddressId` VARCHAR(191) NULL,
    `defaultBillingAddressId` VARCHAR(191) NULL,
...
CREATE TABLE `product_variants` (
    ...
    UNIQUE INDEX `product_variants_productId_size_key`(`productId`, `size`),
    PRIMARY KEY (`id`)
) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
...
CREATE TABLE `orders` (
    ...
    `payment` ENUM('DUE', 'FAILED', 'SUCCESSFUL', 'REFUNDED') NOT NULL DEFAULT 'DUE',
    ...
    UNIQUE INDEX `orders_razorpayId_key`(`razorpayId`),
    PRIMARY KEY (`id`)
) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
